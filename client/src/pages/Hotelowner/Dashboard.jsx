    ...
    <div>
      ...
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img src={totalBookingIcon} alt="" className='max-sm:hidden h-10' />
        ...
        {/* ---- ---Total Revenue-- */}
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img src={totalRevenueIcon} alt="" className='max-sm:hidden h-10' />
          <div className='flex flex-col sm:ml-4 font-medium'>
            <p className='text-blue-500 text-lg'>Total Revenue</p>
            <p className='text-neutral-400 text-base'>{currency}{dashboard.totalRevenue}</p>
          </div>
        </div>
